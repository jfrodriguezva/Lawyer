...
// Caduceo: bastón alado con dos serpientes entrelazadas, símbolo tradicional de
// comercio/gestión administrativa, usado junto a "Trámites SAT" en los menús.
// Trazado con formas rellenas (no líneas finas) para que se lea bien incluso
// al tamaño pequeño en el que aparece junto al texto del menú.
export function IconCaduceus({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} xmlns="http://www.w3.org/2000/svg">
      {/* Bastón */}
      <rect x="11.1" y="6.5" width="1.8" height="14.5" rx="0.6" />
      {/* Serpiente izquierda: dos vueltas cruzando el bastón */}
      <path d="M12 8.3c-3.4 1-5.2 2.7-5.2 4.4s1.8 2.7 3.4 3.7c1.2.8 1.8 1.6 1.8 2.3h1.6c0-1.6-1.1-2.7-2.6-3.7-1.3-.8-2.4-1.6-2.4-2.3 0-1 1.3-2.1 3.4-2.8v-1.6z" />
      {/* Serpiente derecha, simétrica */}
      <path d="M12 8.3c3.4 1 5.2 2.7 5.2 4.4s-1.8 2.7-3.4 3.7c-1.2.8-1.8 1.6-1.8 2.3h-1.6c0-1.6 1.1-2.7 2.6-3.7 1.3-.8 2.4-1.6 2.4-2.3 0-1-1.3-2.1-3.4-2.8v-1.6z" />
      {/* Cabezas de las serpientes, encontradas cerca del bastón */}
      <path d="M12 6.4c-1 0-1.9.5-2.3 1.3.7.5 1.6.5 2.3 0 .7.5 1.6.5 2.3 0-.4-.8-1.3-1.3-2.3-1.3z" />
      {/* Alas */}
      <path d="M11.1 6.9c-2.3-2.6-6.1-2-6.6.4 1.4 1.5 4.2 1.5 6.6-.4z" />
      <path d="M12.9 6.9c2.3-2.6 6.1-2 6.6.4-1.4 1.5-4.2 1.5-6.6-.4z" />
      {/* Remate superior */}
...
// Megáfono: representa el módulo de Comercializadora (marketing/ventas), aún
// pendiente de implementación. Formas rellenas, igual que el caduceo, para que
// se lea con nitidez al tamaño pequeño en el que aparece junto al texto.
export function IconMegaphone({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} xmlns="http://www.w3.org/2000/svg">
      <path d="M3 9.4v5.2h2.3l8.5 4.3V5.1L5.3 9.4H3z" />
      <path d="M17.6 9.8c1.4.7 1.4 3.7 0 4.4-.3-.2-.5-.5-.5-.9.8-.5.8-2.1 0-2.6 0-.4.2-.7.5-.9z" />
      <path d="M20 8.6c2.3 1.6 2.3 6.2 0 7.8-.3-.3-.6-.6-.6-1 1.9-1.5 1.9-4.3 0-5.8 0-.4.3-.7.6-1z" />
      <path d="M6.2 14.6v3.6c0 1 .8 1.8 1.8 1.8h.5c1 0 1.8-.8 1.8-1.8v-2.2H8.7v2.2c0 .1-.1.2-.2.2h-.5c-.1 0-.2-.1-.2-.2v-3.6H6.2z" />
    </svg>
  );
}
