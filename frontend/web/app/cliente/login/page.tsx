...
import { loginCliente, ApiError } from "@/lib/api";
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-brand-ink px-4">
      <div className="w-full max-w-md border border-brand-line bg-brand-ink2 px-10 py-12">
        ...
        <p className="mt-6 text-center text-xs text-brand-creamSoft">
          Tu abogada te da de alta esta cuenta cuando tu expediente está listo para seguimiento.
        </p>

        <Link
          href="/"
          className="mt-4 block text-center text-xs uppercase tracking-widest text-brand-creamSoft transition-colors hover:text-brand-gold"
        >
          ← Volver al sitio
        </Link>
      </div>
